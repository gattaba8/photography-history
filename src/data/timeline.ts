...
export const timelineEvents: TimelineEvent[] = [
  // ─── Les Pionniers (1826–1860) ───────────────────────────────────────
  {
    ...
    illustrations: [
      { url: '/images/view_from_window_niepce.jpg', caption: 'Point de vue du Gras, la plus ancienne photographie connue, réalisée par Niépce vers 1826-1827' },
      { url: '/images/niepce_portrait.jpg', caption: 'Portrait de Nicéphore Niépce, inventeur de la photographie' },
    ],
    category: 'invention',
    era: 'pionniers',
  },
  {
    ...
    illustrations: [
      { url: '/images/talbot_lacock.jpg', caption: 'La cour de Lacock Abbey, calotype de William Henry Fox Talbot' },
    ],
    category: 'invention',
    era: 'pionniers',
  },
  {
    ...
    illustrations: [
      { url: '/images/boulevard_du_temple.jpg', caption: "Boulevard du Temple, Paris, daguerréotype de Daguerre, l'une des premières images montrant un être humain" },
      { url: '/images/louis_daguerre.jpg', caption: 'Louis Jacques Mandé Daguerre, inventeur du daguerréotype' },
    ],
    category: 'milestone',
    era: 'pionniers',
  },
  {
    ...
    illustrations: [
      { url: '/images/robert_cornelius.jpg', caption: "Autoportrait de Robert Cornelius (1839), considéré comme le premier portrait et le premier selfie de l'histoire" },
    ],
    category: 'milestone',
    era: 'pionniers',
  },
  {
    ...
    illustrations: [
      { url: '/images/hamburg_1842.jpg', caption: 'Daguerréotype des ruines de Hambourg après le grand incendie de 1842' },
    ],
    category: 'milestone',
    era: 'pionniers',
  },
  {
    ...
    illustrations: [
      { url: '/images/le_gray_moissac.jpg', caption: "Abbaye de Moissac photographiée par Gustave Le Gray et Auguste Mestral lors de la Mission Héliographique (1851)" },
    ],
    category: 'movement',
    era: 'pionniers',
  },
  ...
  // ─── L'Âge du Collodion (1851–1880) ──────────────────────────────────
  {
    ...
    illustrations: [
      { url: '/images/collodion_humide.jpg', caption: "Démonstration du procédé au collodion humide, le collodion est versé sur une plaque de verre" },
    ],
    category: 'invention',
    era: 'collodion',
  },
  {
    ...
    illustrations: [
      { url: '/images/disderi_carte_visite.jpg', caption: 'Carte de visite photographique réalisée par le studio Disdéri' },
    ],
    category: 'technique',
    era: 'collodion',
  },
  {
    ...
    illustrations: [
      { url: '/images/tartan_ribbon.jpg', caption: 'Le ruban de tartan, première photographie couleur réalisée par James Clerk Maxwell en 1861' },
    ],
    category: 'invention',
    era: 'collodion',
  },
  {
    ...
    illustrations: [
      { url: '/images/gelatino_plaque.jpg', caption: "Plaque sèche au gélatino-bromure d'argent" },
    ],
    category: 'invention',
    era: 'collodion',
  },
  {
    ...
    illustrations: [
      { url: '/images/horse_in_motion.jpg', caption: "The Horse in Motion (1878), Eadweard Muybridge prouve que les quatre sabots du cheval quittent le sol simultanément" },
    ],
    category: 'technique',
    era: 'collodion',
  },
  ...
  // ─── La Démocratisation (1880–1920) ───────────────────────────────────
  {
    ...
    illustrations: [
      { url: '/images/kodak_no1.jpg', caption: 'Le Kodak n°1, lancé par George Eastman en 1888' },
    ],
    category: 'camera',
    era: 'democratisation',
  },
  {
    ...
    illustrations: [
      { url: '/images/film_35mm.jpg', caption: 'Film souple en rouleau, le support qui a révolutionné la photographie et rendu possible le cinéma' },
    ],
    category: 'invention',
    era: 'democratisation',
  },
  {
    ...
    illustrations: [
      { url: '/images/kodak_brownie.jpg', caption: 'Le Kodak Brownie, vendu 1 dollar, il met la photographie à la portée de tous' },
    ],
    category: 'camera',
    era: 'democratisation',
  },
  {
    ...
    illustrations: [
      { url: '/images/autochrome.jpg', caption: 'Autochrome des frères Lumière, le rendu pointilliste caractéristique des grains de fécule de pomme de terre teints' },
    ],
    category: 'invention',
    era: 'democratisation',
  },
  {
    ...
    illustrations: [
      { url: '/images/leica_i.jpg', caption: 'Leica I Model A, version commerciale dérivée du prototype Ur-Leica de Barnack' },
    ],
    category: 'camera',
    era: 'democratisation',
  },
  {
    ...
    illustrations: [
      { url: '/images/ww1_trench.jpg', caption: 'Soldats du Cheshire Regiment dans une tranchée de la Somme (1916)' },
    ],
    category: 'movement',
    era: 'democratisation',
  },
  ...
  // ─── L'Âge d'Or (1920–1960) ──────────────────────────────────────────
  {
    ...
    image: '/images/leica_i.jpg',
    illustrations: [
      { url: '/images/leica_i.jpg', caption: "Leica I Model A avec objectif Elmar 50mm, l'appareil qui a inventé la photographie 35mm" },
    ],
    category: 'camera',
    era: 'age-or',
  },
  {
    ...
    image: '/images/life_magazine_logo.svg',
        illustrations: [
      { url: '/images/bourke_white.jpg', caption: 'Margaret Bourke-White, première femme photographe de guerre accréditée et photographe vedette de LIFE' },
      { url: '/images/eisenstaedt.jpg', caption: 'Alfred Eisenstaedt à Paris en 1963, photographe emblématique du magazine LIFE' },
    ],
    category: 'movement',
    era: 'age-or',
  },
  {
    ...
    illustrations: [
      { url: '/images/exakta.jpg', caption: "Exakta Varex IIb avec objectif Carl Zeiss Pancolar, descendant du premier SLR 35mm" },
    ],
    category: 'camera',
    era: 'age-or',
  },
  {
    ...
    image: '/images/kodachrome.jpg',
        illustrations: [
      { url: '/images/film_cartridges.jpg', caption: 'Film Kodachrome en cartouche, le film couleur le plus célèbre de Kodak' },
    ],
    category: 'invention',
    era: 'age-or',
  },
  {
    ...
    illustrations: [
      { url: '/images/polaroid_95.jpg', caption: 'Polaroid Land Camera Model 95, le premier appareil à développement instantané (MIT Museum)' },
    ],
    category: 'invention',
    era: 'age-or',
  },
  {
    ...
    illustrations: [
      { url: '/images/hasselblad_500c.jpg', caption: "Hasselblad 500C, l'appareil moyen format qui ira sur la Lune" },
    ],
    category: 'camera',
    era: 'age-or',
  },
  {
    ...
    image: '/images/cartier_bresson.png',
        illustrations: [
      { url: '/images/cartier_bresson.png', caption: "Couverture de « Images à la Sauvette » (The Decisive Moment), dessinée par Henri Matisse (1952)" },
    ],
    category: 'movement',
    era: 'age-or',
  },
  ...
  // ─── La Révolution SLR (1960–1990) ────────────────────────────────────
  {
    ...
    illustrations: [
      { url: '/images/nikon_f.jpg', caption: "Nikon F avec tête de mesure Photomic FTn, l'appareil des photojournalistes au Vietnam" },
    ],
    category: 'camera',
    era: 'revolution-slr',
  },
  {
    ...
    illustrations: [
      { url: '/images/canonet.jpg', caption: "Canon Canonet QL17 GIII, exemple d'appareil compact à exposition automatique des années 1970" },
    ],
    category: 'technique',
    era: 'revolution-slr',
  },
  {
    ...
    illustrations: [
      { url: '/images/instamatic.jpg', caption: "Kodak Instamatic 50 avec sa cartouche de film 126 à chargement simplifié" },
    ],
    category: 'camera',
    era: 'revolution-slr',
  },
  {
    ...
    illustrations: [
      { url: '/images/aldrin_apollo11.jpg', caption: "Buzz Aldrin sur la Lune, photographié par Neil Armstrong avec un Hasselblad 500 EL (20 juillet 1969)" },
    ],
    category: 'milestone',
    era: 'revolution-slr',
  },
  {
    ...
    illustrations: [
      { url: '/images/sasson_digital.jpg', caption: "Le premier appareil photo numérique, construit par Steven Sasson chez Kodak en 1975, 0,01 mégapixel, 3,6 kg" },
    ],
    category: 'invention',
    era: 'revolution-slr',
  },
  {
    ...
    illustrations: [
      { url: '/images/konica_c35af.jpg', caption: "Konica C35 AF (1977), le premier appareil photo grand public avec autofocus" },
    ],
    category: 'invention',
    era: 'revolution-slr',
  },
  {
    ...
    illustrations: [
      { url: '/images/minolta_7000.jpg', caption: "Minolta 7000 AF (1985), le premier reflex 35mm à autofocus intégré au boîtier" },
    ],
    category: 'camera',
    era: 'revolution-slr',
  },
  ...
  // ─── L'Ère Numérique (1990–2010) ─────────────────────────────────────
  {
    ...
    image: '/images/photoshop_icon.svg',
        illustrations: [
      { url: '/images/photoshop_icon.svg', caption: 'Icône Adobe Photoshop, le logiciel qui a redéfini la retouche photographique depuis 1990' },
    ],
    category: 'digital',
    era: 'numerique',
  },
  {
    ...
    illustrations: [
      { url: '/images/kodak_dcs.jpg', caption: "Kodak DCS 620, successeur du DCS original, basé sur un boîtier Nikon" },
    ],
    category: 'camera',
    era: 'numerique',
  },
  {
    ...
    illustrations: [
      { url: '/images/nikon_d1.jpg', caption: "Nikon D1, premier reflex numérique entièrement conçu par un fabricant d'appareils photo (1999)" },
    ],
    category: 'camera',
    era: 'numerique',
  },
  {
    ...
    illustrations: [
      { url: '/images/sharp_jsh04.jpg', caption: "Sharp J-SH04, le premier téléphone portable avec appareil photo intégré (2000)" },
    ],
    category: 'milestone',
    era: 'numerique',
  },
  {
    ...
    illustrations: [
      { url: '/images/canon_300d.jpg', caption: "Canon EOS 300D (Digital Rebel), le premier reflex numérique à moins de 1000 dollars (2003)" },
    ],
    category: 'camera',
    era: 'numerique',
  },
  {
    ...
    image: '/images/flickr_logo.svg',
        illustrations: [
      { url: '/images/flickr_logo.svg', caption: 'Logo Flickr, la plateforme pionnière du partage photographique en ligne (2004)' },
    ],
    category: 'digital',
    era: 'numerique',
  },
  ...
  // ─── L'Ère du Smartphone (2010–2026) ──────────────────────────────────
  {
    ...
    illustrations: [
      { url: '/images/iphone_original.jpg', caption: "L'iPhone original (2007) sur son dock, l'appareil qui a transformé la photographie mobile" },
    ],
    category: 'milestone',
    era: 'smartphone',
  },
  {
    ...
    image: '/images/instagram_logo_2016.svg',
        illustrations: [
      { url: '/images/instagram_logo_2016.svg', caption: "Logo Instagram, l'application qui a transformé la photographie en langage social" },
      { url: '/images/instagram_logo_2022.svg', caption: "Logo Instagram actuel, plus de 2 milliards d'utilisateurs actifs mensuels" },
    ],
    category: 'digital',
    era: 'smartphone',
  },
  {
    ...
    illustrations: [
      { url: '/images/sony_a7.jpg', caption: "Sony Alpha 7R IV, héritier de l'A7 original, premier hybride plein format" },
    ],
    category: 'camera',
    era: 'smartphone',
  },
  {
    ...
    image: '/images/iphone7plus.jpg',
        illustrations: [
      { url: '/images/iphone7plus.jpg', caption: "iPhone 7 Plus, premier iPhone à double capteur photo, inaugurant le mode Portrait à effet bokeh" },
    ],
    category: 'technique',
    era: 'smartphone',
  },
  {
    ...
    image: '/images/aurora_borealis.jpg',
        illustrations: [
      { url: '/images/aurora_borealis.jpg', caption: 'Aurore boréale capturée grâce à la photographie computationnelle, fusion de multiples expositions par algorithme' },
    ],
    category: 'technique',
    era: 'smartphone',
  },
  {
    ...
    image: '/images/samsung_s20ultra.png',
        illustrations: [
      { url: '/images/samsung_s20ultra.png', caption: 'Samsung Galaxy S20 Ultra 5G, équipé du capteur ISOCELL Bright HM1 de 108 mégapixels' },
    ],
    category: 'technique',
    era: 'smartphone',
  },
  {
    ...
    image: '/images/theatre_opera_spatial.png',
        illustrations: [
      { url: '/images/theatre_opera_spatial.png', caption: "« Théâtre D'opéra Spatial », image générée par Midjourney ayant remporté un prix au Colorado State Fair (2022)" },
    ],
    category: 'digital',
    era: 'smartphone',
  },
