...
export const timelineEvents: TimelineEvent[] = [
  // ─── Les Pionniers (1826–1860) ───────────────────────────────────────
  {
    ...
    illustrations: [
      { url: '/images/niepce_portrait.jpg', caption: "Portrait de Nicéphore Niépce, inventeur de l'héliographie" },
    ],
    category: 'invention',
    era: 'pionniers',
  },
  {
    ...
    illustrations: [
      { url: '/images/calotype_pencil_of_nature.jpg', caption: 'Page de « The Pencil of Nature » (1844), premier livre illustré de photographies' },
    ],
    category: 'invention',
    era: 'pionniers',
  },
  ...
  },
  {
    ...
    illustrations: [
      { url: '/images/victorian_daguerreotype.jpg', caption: 'Couple victorien posant pour un daguerréotype dans les années 1840' },
    ],
    category: 'milestone',
    era: 'pionniers',
  },
  ...
  // ─── L'Âge du Collodion (1851–1880) ──────────────────────────────────
  {
    ...
    illustrations: [
      { url: '/images/wet_plate_demo.jpg', caption: 'Démonstration moderne du procédé au collodion humide sur plaque de verre' },
    ],
    category: 'invention',
    era: 'collodion',
  },
  {
    ...
    illustrations: [
      { url: '/images/dickens_carte_visite.jpg', caption: 'Charles Dickens photographié en carte de visite, vers 1865' },
    ],
    category: 'technique',
    era: 'collodion',
  },
  ...
  },
  {
    ...
    illustrations: [
      { url: '/images/zoopraxiscope_anim.gif', caption: 'Animation du zoopraxiscope de Muybridge, reconstitution du galop du cheval' },
    ],
    category: 'technique',
    era: 'collodion',
  },
  ...
  },
  {
    ...
    illustrations: [
      { url: '/images/deserted_trench_ww1.jpg', caption: 'Tranchée désertée pendant la Première Guerre mondiale' },
    ],
    category: 'movement',
    era: 'democratisation',
  },
  ...
  },
  {
    ...
    image: '/images/life_magazine_logo.svg',
        illustrations: [
      { url: '/images/bourke_white.jpg', caption: 'Margaret Bourke-White (1955), photographe vedette du magazine LIFE' },
      { url: '/images/eisenstaedt.jpg', caption: 'Alfred Eisenstaedt à New York (1954), photographe emblématique de LIFE' },
    ],
    category: 'movement',
    era: 'age-or',
  },
  ...
  },
  {
    ...
    image: '/images/kodachrome.jpg',
        illustrations: [
      { url: '/images/film_cartridges.jpg', caption: 'Cartouches de film couleur 35mm, héritières du Kodacolor de 1942' },
    ],
    category: 'invention',
    era: 'age-or',
  },
  ...
  },
  {
    ...
    illustrations: [
      { url: '/images/earthrise_apollo8.jpg', caption: 'Earthrise (lever de Terre), photographié depuis Apollo 8 avec un Hasselblad (décembre 1968)' },
    ],
    category: 'camera',
    era: 'age-or',
  },
  ...
  },
  {
    ...
    illustrations: [
      { url: '/images/sony_a7_no_cap.jpg', caption: 'Sony Alpha 7 (A7) sans bouchon, montrant le capteur plein format' },
    ],
    category: 'camera',
    era: 'smartphone',
  },
